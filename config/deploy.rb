...
role :web, "162.243.147.78"                   # Your HTTP server, Apache/etc
role :app, "162.243.147.78"                   # This may be the same as your `Web` server
role :db,  "162.243.147.78", :primary => true # This is where Rails migrations will run
