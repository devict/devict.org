  ...
  var h = function(g, n) {
        ...
        (function() {
          ...
          if (null === a.style.transform) {
            var b = ['Webkit', 'Moz', 'ms'],
              d
            for (d in b)
              if (void 0 !== a.style[b[d] + 'Transform'])
                return b[d] + 'Transform'
          }
          return 'transform'
        })()
    a.options = {
    ...
    var u = function() {
      ...
      v = function() {
        ...
        return (c != k && a.options.vertical) ||
          (b != l && a.options.horizontal)
          ? !0
          : !1
      },
      w = function(c, b, d) {
      ...
      x = function() {
        for (var c, b = 0; b < a.elems.length; b++) {
          c = w(
            (l - e[b].left + q) / (e[b].width + q),
            (k - e[b].top + p) / (e[b].height + p),
            e[b].speed
          )
          var d = c.y - e[b].baseY,
            g = c.x - e[b].baseX
